				...
				<div class="mt-5 border rounded">   
					<div class="col-12 px-1">
						<div class="row">
							...
							<div class="col-10 pb-4 pt-3 text-left d-flex">
								<div>
								...
								<div class="d-flex">
									<form action="delete.php" method="GET">
			 							<input style="display: none;" value="<?php echo $stroka["id"];?>" name="id">
			 							<button class="btn3" style="margin-left: 350px;"><i class="fa fa-trash"></i></button>
			 						</form>	
			 						<button class="button btn3 ml-2"><i class="fa fa-edit"></i></button>	
								</div>
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div style="display: none;" class="box ">
							<form action="update.php" method="GET">
								<input type="" name="id" placeholder="ID" class=" border rounded text-center border-secondary" value=<?php echo $stroka['id']?>>
								<input type="" name="text" placeholder="Text" class=" border rounded text-center border-secondary" value=<?php echo $stroka['text']?>>
								<input type="" name="img" placeholder="Img" class=" border rounded text-center border-secondary" value=<?php echo $stroka['img']?>>
